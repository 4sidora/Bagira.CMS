...
(function($) {
	...
	$.fn.prettyPhoto = function(settings) {
		settings = jQuery.extend({
			...
			flash_markup: '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="{width}" height="{height}"><param name="wmode" value="{wmode}" /><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="movie" value="/css_mpanel/uppod.swf" /><param name="flashvars" value="comment=player_1&amp;st=/css_mpanel/video5-1342.txt&amp;file={path}" /><embed src="/css_mpanel/uppod.swf" wmode="{wmode}" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" flashvars="comment=player_1&amp;st=/css_mpanel/video5-1342.txt&amp;file={path}" width="{width}" height="{height}"></embed></object>',
		...
		*/
		...
		function _getFileType(itemSrc){
			if (itemSrc.match(/youtube\.com\/watch/i)) {
				...
				return 'quicktime';
			}else if(itemSrc.indexOf('.swf') != -1 || itemSrc.indexOf('.flv') != -1){
				return 'flash';
